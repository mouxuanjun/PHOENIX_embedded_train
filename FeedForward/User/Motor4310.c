...
void Get_DM4310_Motor_Message(uint32_t StdId,uint8_t rx_data[8])
{
    switch(StdId)
    {
        case 0x207:
        {
            GM6020.rotor_angle    = ((rx_data[0] << 8) | rx_data[1]);//½ӊջúе½Ƕȣ¨16bit£©
            ...
            break;
				...
				case 0x205:
        {
            GM6020_pitch.rotor_angle    = ((rx_data[0] << 8) | rx_data[1]);//½ӊջúе½Ƕȣ¨16bit£©
