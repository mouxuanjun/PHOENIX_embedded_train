...
static void DecodeVision()
{
    ...
    // TODO: code to resolve flag_register;//通过老的麦轮代码添加，发行版未添加
...
void VisionSend()
{
    ...
    static uint16_t tx_len;
    // TODO: code to set flag_register
    flag_register = 30 << 8 | send_data.self_color; //该flag_register为16位寄存器，用于存放：弹速、workmode（视觉击打目标：小符大符）、本车颜色，所占位为：8、4、4
    //此处左移8是不需要workmode，后续可添加
